    ...
    class FileWatcher : public IFileWatcher
    {
      ...
      private:
        struct DirectoryWatch
        {
            ...
            // Buffer passed into ReadDirectoryChangesW must be aligned on DWORD
            // boundary.
            alignas(sizeof(DWORD)) std::uint8_t buffer[32 * 1024];
        ...
        static void WINAPI WatchCallback(DWORD error,
